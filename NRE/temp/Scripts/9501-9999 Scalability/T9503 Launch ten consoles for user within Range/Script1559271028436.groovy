...
'Enter the sixth console name into the VM filter'
WebUI.setText(findTestObject('Page_PCTE Portal/input_Ranges_VMFilter'), GlobalVariable.console6)

'Wait 5 seconds for the filtering to finish'
TestSupport.delay(5)

'View the sixth console'
WebUI.click(findTestObject('Page_PCTE Portal/div_Content_DynamicRangeViewConsole', [('consoleName') : GlobalVariable.console6]))

'Wait for the console window to load'
TestSupport.delay(2)

'Switch the newly launched console window'
WebUI.switchToWindowTitle((('PCTE Portal (Console): ' + GlobalVariable.range_name) + ', ') + GlobalVariable.console6)
...
'Enter the seventh console name into the VM filter'
WebUI.setText(findTestObject('Page_PCTE Portal/input_Ranges_VMFilter'), GlobalVariable.console7)

'Wait 5 seconds for the filtering to finish'
TestSupport.delay(5)

'View the seventh console'
WebUI.click(findTestObject('Page_PCTE Portal/div_Content_DynamicRangeViewConsole', [('consoleName') : GlobalVariable.console7]))

'Wait for the console window to load'
TestSupport.delay(2)

'Switch the newly launched console window'
WebUI.switchToWindowTitle((('PCTE Portal (Console): ' + GlobalVariable.range_name) + ', ') + GlobalVariable.console7)
...
'Enter the eighth console name into the VM filter'
WebUI.setText(findTestObject('Page_PCTE Portal/input_Ranges_VMFilter'), GlobalVariable.console8)

'Wait 5 seconds for the filtering to finish'
TestSupport.delay(5)

'View the eigth console'
WebUI.click(findTestObject('Page_PCTE Portal/div_Content_DynamicRangeViewConsole', [('consoleName') : GlobalVariable.console8]))

'Wait for the console window to load'
TestSupport.delay(2)

'Switch the newly launched console window'
WebUI.switchToWindowTitle((('PCTE Portal (Console): ' + GlobalVariable.range_name) + ', ') + GlobalVariable.console8)
...
'Enter the ninth console name into the VM filter'
WebUI.setText(findTestObject('Page_PCTE Portal/input_Ranges_VMFilter'), GlobalVariable.console9)

'Wait 5 seconds for the filtering to finish'
TestSupport.delay(5)

'View the ninth console'
WebUI.click(findTestObject('Page_PCTE Portal/div_Content_DynamicRangeViewConsole', [('consoleName') : GlobalVariable.console9]))

'Wait for the console window to load'
TestSupport.delay(2)

'Switch the newly launched console window'
WebUI.switchToWindowTitle((('PCTE Portal (Console): ' + GlobalVariable.range_name) + ', ') + GlobalVariable.console9)
...
'Enter the tenth console name into the VM filter'
WebUI.setText(findTestObject('Page_PCTE Portal/input_Ranges_VMFilter'), GlobalVariable.console10)

'Wait 5 seconds for the filtering to finish'
TestSupport.delay(5)

'View the tenth console'
WebUI.click(findTestObject('Page_PCTE Portal/div_Content_DynamicRangeViewConsole', [('consoleName') : GlobalVariable.console10]))

'Wait for the console window to load'
TestSupport.delay(2)

'Switch the newly launched console window'
WebUI.switchToWindowTitle((('PCTE Portal (Console): ' + GlobalVariable.range_name) + ', ') + GlobalVariable.console10)
...
'Close the sixth console window'
WebUI.closeWindowTitle((('PCTE Portal (Console): ' + GlobalVariable.range_name) + ', ') + GlobalVariable.console6)

'Close the seventh console window'
WebUI.closeWindowTitle((('PCTE Portal (Console): ' + GlobalVariable.range_name) + ', ') + GlobalVariable.console7)

'Close the eigth console window'
WebUI.closeWindowTitle((('PCTE Portal (Console): ' + GlobalVariable.range_name) + ', ') + GlobalVariable.console8)

'Close the ninth console window'
WebUI.closeWindowTitle((('PCTE Portal (Console): ' + GlobalVariable.range_name) + ', ') + GlobalVariable.console9)

'Close the tenth console window'
WebUI.closeWindowTitle((('PCTE Portal (Console): ' + GlobalVariable.range_name) + ', ') + GlobalVariable.console10)
